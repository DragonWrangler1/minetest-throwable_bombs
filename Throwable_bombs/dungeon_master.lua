...
mobs:register_mob("throwable_bombs:dungeon_master", {
	type = "monster",
	passive = false,
	damage = 6,
	...
	reach = 3,
	shoot_interval = 5.2,
	arrow = "throwable_bombs:bomb_engage",
	friendly_fire = false,
	shoot_offset = 1,
	hp_min = 42,
	hp_max = 75,
...
if not mobs.custom_spawn_monster then
	...
	mobs:spawn({
		name = "throwable_bombs:dungeon_master",
...
mobs:register_egg("throwable_bombs:dungeon_master", S("Dungeon Master"), "fire_basic_flame.png", 1, true)


mobs:alias_mob("mobs:dungeon_master", "throwable_bombs:dungeon_master") -- compatibility


-- fireball (weapon)
mobs:register_arrow("throwable_bombs:fireball", {
	visual = "sprite",
	visual_size = {x = 1, y = 1},
