...
function tnt.register_tnt(def)
	...
	local tnt_top = def.tiles.top or def.name .. "_tnt_top.png"
	local tnt_bottom = def.tiles.bottom or def.name .. "_tnt_bottom.png"
	local tnt_side = def.tiles.side or def.name .. "_tnt_side.png"
	local tnt_burning = def.tiles.burning or def.name .. "_tnt_top_animated.png"
	...
	minetest.register_node(":tnt:tnt_burning", {
		tiles = {
			...
			"tnt_tnt_bottom.png", "tnt_tnt_side.png"
			},
		light_source = 5,
		drop = "",
		sounds = default.node_sound_wood_defaults(),
